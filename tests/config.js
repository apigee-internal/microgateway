...
describe('configure', () => {
    ...
    describe('locations module', () => {
        it('will build a source path without a configDir', () => {
            let configPath = locations.getSourcePath('test', 'foo');
